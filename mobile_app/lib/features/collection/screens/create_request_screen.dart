            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _selectedRequestId == null ? null : () async {
                    ...
                    final success = await context.read<WorkflowController>().sendToLab(
                      ...
                      method: '${_methodCtrl.text.trim()} (Facility: ${_facilityCtrl.text.trim()}, Moisture: ${_moistureCtrl.text.trim()}%)',
                    ...
                    if (context.mounted && success) {
                       ...
                       ScaffoldMessenger.of(context).showSnackBar(
                         const SnackBar(content: Text('Failed to process request'), backgroundColor: AppConstants.error),
                       );
                    }
                  },
