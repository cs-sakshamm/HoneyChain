...
router.post('/requests/:id/send-next', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const id = String(req.params.id);
        const { actorId, actorRole, quantityReceived, quantityAfter, method, moistureAtReceipt, notes } = req.body;
        ...
        if (currentRequest.requestType === 'COLLECTION_TO_LAB') {
            ...
            const prov = yield recordWorkflowProvenance(batch.id, 'LAB_SENT_TO_PACKAGING', labOfficer.id, result.id, {
                ...
                labReportId: (_a = currentRequest.labReport) === null || _a === void 0 ? void 0 : _a.id
            });
            return res.json({
                success: true,
...
router.post('/lab-reports', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { batchId, requestId, labId, testResults, qualityScore = 95.0, moistureContent = 16.8, purityGrade = 'Grade A', contaminantsFound = 'None', notes } = req.body;
        if (!batchId) {
            return res.status(400).json({ success: false, error: 'batchId is required' });
        }
        ...
        const stages = [
            {
                ...
                date: ((_b = batch.harvest) === null || _b === void 0 ? void 0 : _b.createdAt) || batch.createdAt,
                actor: ((_d = (_c = batch.harvest) === null || _c === void 0 ? void 0 : _c.harvester) === null || _d === void 0 ? void 0 : _d.name) || 'Harvester',
                details: `${((_e = batch.harvest) === null || _e === void 0 ? void 0 : _e.quantity) || 0} kg from ${((_f = batch.harvest) === null || _f === void 0 ? void 0 : _f.location) || 'Apiary'}`
            },
            {
                stage: 'COLLECTION',
                title: 'Collection & Processing',
                completed: hasProcessing,
                date: ((_g = batch.processingRecords[0]) === null || _g === void 0 ? void 0 : _g.createdAt) || null,
                actor: ((_j = (_h = batch.processingRecords[0]) === null || _h === void 0 ? void 0 : _h.processor) === null || _j === void 0 ? void 0 : _j.name) || null,
            ...
            },
            {
                ...
                actor: ((_k = verifiedLab === null || verifiedLab === void 0 ? void 0 : verifiedLab.lab) === null || _k === void 0 ? void 0 : _k.name) || null,
                details: verifiedLab
            ...
            },
            {
                ...
                date: ((_l = batch.packagingRecords[0]) === null || _l === void 0 ? void 0 : _l.createdAt) || null,
                actor: ((_o = (_m = batch.packagingRecords[0]) === null || _m === void 0 ? void 0 : _m.packager) === null || _o === void 0 ? void 0 : _o.name) || null,
