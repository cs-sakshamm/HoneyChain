...
# Configuration
RPC_URL = os.getenv("BLOCKCHAIN_PROVIDER_URL", "http://127.0.0.1:8545")
PRIVATE_KEY = os.getenv("BLOCKCHAIN_PRIVATE_KEY", "0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80")
CONTRACT_ADDRESS = os.getenv("CONTRACT_ADDRESS", "0x5FbDB2315678afecb367f032d93F642f64180aa3")
NETWORK_NAME = os.getenv("BLOCKCHAIN_NETWORK_NAME", "Hardhat Localhost (Chain ID: 31337)")
