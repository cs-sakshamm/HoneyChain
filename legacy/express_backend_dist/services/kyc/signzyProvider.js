...
exports.SignzyAadhaarProvider = void 0;
const crypto = __importStar(require("crypto"));
class SignzyAadhaarProvider {
    constructor() {
        this.providerName = 'Signzy (UIDAI-Authorized KYC Provider)';
    ...
    initiateAadhaarOtp(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield fetch(`${this.baseUrl}/patrons/aadhaar/otp`, {
                    method: 'POST',
                    headers: {
                ...
                if (!response.ok || !(data === null || data === void 0 ? void 0 : data.result)) {
                    throw new Error((data === null || data === void 0 ? void 0 : data.message) || ((_a = data === null || data === void 0 ? void 0 : data.error) === null || _a === void 0 ? void 0 : _a.message) || 'Signzy Aadhaar OTP dispatch failed.');
                }
                return {
                    success: true,
                ...
                throw new Error((err === null || err === void 0 ? void 0 : err.message) || 'Failed to communicate with Signzy Aadhaar provider.');
            }
        });
    }
    verifyAadhaarOtp(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield fetch(`${this.baseUrl}/patrons/aadhaar/verify`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': this.apiKey,
                ...
                const data = yield response.json();
                if (!response.ok || !(data === null || data === void 0 ? void 0 : data.result)) {
                    throw new Error((data === null || data === void 0 ? void 0 : data.message) || ((_a = data === null || data === void 0 ? void 0 : data.error) === null || _a === void 0 ? void 0 : _a.message) || 'Signzy Aadhaar OTP verification failed.');
                }
                ...
                throw new Error((err === null || err === void 0 ? void 0 : err.message) || 'Failed to verify OTP with Signzy Aadhaar provider.');
            }
        });
    }
}
exports.SignzyAadhaarProvider = SignzyAadhaarProvider;
