...
exports.calculateHaversineDistanceKm = exports.parseCoordinates = void 0;
/**
...
function parseCoordinates(coordStr) {
    ...
    if (lower.includes('bend') || lower.includes('cascade valley'))
        return { lat: 44.0582, lng: -121.3153 };
    if (lower.includes('corvallis'))
        return { lat: 44.5646, lng: -123.2620 };
    if (lower.includes('portland'))
        return { lat: 45.5152, lng: -122.6784 };
    if (lower.includes('eugene'))
        return { lat: 44.0521, lng: -123.0868 };
    if (lower.includes('salem'))
        return { lat: 44.9429, lng: -123.0351 };
    if (lower.includes('redmond'))
        return { lat: 44.2726, lng: -121.1739 };
    if (lower.includes('tigard'))
        return { lat: 45.4312, lng: -122.7712 };
    if (lower.includes('noida') || lower.includes('delhi'))
