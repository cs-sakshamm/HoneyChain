...
exports.generateUniqueHiveCode = void 0;
...
exports.generateUniqueHiveCode = generateUniqueHiveCode;
/**
 * GET /api/hives
...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const targetUserId = queryUserId || harvesterId || beekeeperId || headerUserId;
        const whereClause = {};
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const rawUserId = data.userId || data.harvesterId || data.beekeeperId || req.headers['x-user-id'];
        ...
        if (!(0, profileService_1.isUserProfileComplete)(user)) {
            return res.status(403).json(profileService_1.BEEKEEPER_PROFILE_INCOMPLETE_RESPONSE);
        }
        // 3. Mandatory Harvester Verification Gate
        if (user.role === 'HARVESTER' && !(0, profileService_1.isHarvesterFullyVerified)(user.harvesterVerification)) {
